...
const imageMeta = [
    ...
    { title: "Landscape", description: "Trail in Cupertino, CA. Taken July 19th, 2025."},
    { title: "Glider", description: "Some folks gliding near Mission Peak. Taken May 26th, 2025."},
    { title: "Birdy", description: "Bird hit a pose for the paparazzi. Taken May 26th, 2025."},
    { title: "Towers", description: "Cell towers (I think?) near Mission Peak. Taken May 26th, 2025."},
    { title: "Mission Peak", description: "View from Mission Peak. Taken May 26th, 2025."},
    { title: "Munchin'", description: "Eating good. Taken May 25th, 2025."},
    { title: "Crow", description: "Someone mistook this for a chicken, unbelievable. Taken May 22nd, 2025." },
    { title: "Squirrel", description: "Practicing the wildlife shots. Taken May 22nd, 2025." },
...
for (let i = totalImages; i > 0; i--) {
    if (imageMeta[totalImages-i].title == "NOT INCLUDED") continue;
    ...
    title.textContent = imageMeta[totalImages-i]?.title || `Untitled ${i}`;

    const desc = document.createElement('p');
    desc.textContent = imageMeta[totalImages-i]?.description || "";
